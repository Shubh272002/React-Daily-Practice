      ...
      <div className="container">
        <div className="row gy-4">
          <div
            ...
            data-aos-delay={100}
          >
            <img src="/static/assets/img/about.jpg" className="img-fluid" alt="" />
          </div>
          <div
        ...
        <div className="row">
          ...
          >
            <div className="course-item">
              <img
                src="/static/assets/img/course-1.jpg"
                className="img-fluid"
                alt="..."
              />
              <div className="course-content">
                ...
                <div className="trainer d-flex justify-content-between align-items-center">
                  <div className="trainer-profile d-flex align-items-center">
                    <img
                      src="/static/assets/img/trainers/trainer-1-2.jpg"
                      className="img-fluid"
                      alt=""
                    />
          ...
          >
            <div className="course-item">
              <img
                src="/static/assets/img/course-2.jpg"
                className="img-fluid"
                alt="..."
              />
              <div className="course-content">
          ...
          >
            <div className="course-item">
              <img
                src="/static/assets/img/course-3.jpg"
                className="img-fluid"
                alt="..."
              />
              <div className="course-content">
